...
import { QuizManager } from './quiz.js'; // ✅ Correction
...
class App {
    constructor() {
        this.auth = new Auth();
        this.payment = null;
        this.quizManager = null; // ✅ Renommer
    ...
    init() {
        ...
        if (window.location.pathname.includes('quiz.html')) {
            this.quizManager = new QuizManager(); // ✅ Correction
        }
    ...
    logDiagnostic() {
        ...
        console.log('   - QuizManager initialisé:', this.quizManager ? 'OUI' : 'NON'); // ✅ Correction
    }
}
